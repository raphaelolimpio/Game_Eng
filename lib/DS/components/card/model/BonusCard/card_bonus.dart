...
import 'package:game_eng_software/DS/components/card/model/BonusCard/card_bonus_view_model.dart.dart';
...
class CardBonus extends StatelessWidget {
  final CardBonusViewModel viewModel;

  const CardBonus._({required this.viewModel});

  static Widget instantiate(CardBonusViewModel viewModel) {
    return CardBonus._(viewModel: viewModel);
  }

  Color _getBorderColor(CardTypeBordBonus type) {
    switch (type) {
      case CardTypeBordBonus.cardGreen:
        return borderCardBonusGreenColor;
      case CardTypeBordBonus.cardGold:
        return borderCardBonusGoldColor;
      case CardTypeBordBonus.cardBlack:
        return borderCardBonusBlackColor;
    }
  }
